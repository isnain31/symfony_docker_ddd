...
final class Version20220819094340 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE donner_kebab (id VARCHAR(255) NOT NULL, meat INT DEFAULT NULL, salad INT DEFAULT NULL, bread INT DEFAULT NULL, price DOUBLE PRECISION NOT NULL, INDEX IDX_57F080D38D9A16CA (meat), INDEX IDX_57F080D38C3E3087 (salad), INDEX IDX_57F080D39CC34D4B (bread), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE donner_kebab ADD CONSTRAINT FK_57F080D38D9A16CA FOREIGN KEY (meat) REFERENCES meat (id)');
        $this->addSql('ALTER TABLE donner_kebab ADD CONSTRAINT FK_57F080D38C3E3087 FOREIGN KEY (salad) REFERENCES salad (id)');
        $this->addSql('ALTER TABLE donner_kebab ADD CONSTRAINT FK_57F080D39CC34D4B FOREIGN KEY (bread) REFERENCES bread (id)');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE donner_kebab DROP FOREIGN KEY FK_57F080D38D9A16CA');
        $this->addSql('ALTER TABLE donner_kebab DROP FOREIGN KEY FK_57F080D38C3E3087');
        $this->addSql('ALTER TABLE donner_kebab DROP FOREIGN KEY FK_57F080D39CC34D4B');
        $this->addSql('DROP TABLE bread');
        $this->addSql('DROP TABLE donner_kebab');
